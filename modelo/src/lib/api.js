...
export async function baixarModelo(token) {
  ...
  a.href = url;
  // Nome versionado (v260714 = modelo de 14/07/2026) — manter igual ao servido pelo
  // backend (`/api/modelo`), senão o operador não distingue de versões antigas baixadas.
  a.download = "Anexo V - Planilha - Painel de Monitoramento - MME-CC_UF.v260714.xlsx";
